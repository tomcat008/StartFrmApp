...
namespace ModemCtlApp
{
    public class PDUEncoding
    {
        ...
        //    this.userDataLength = strPDU.Substring((length + num2) + 20, 2);
        //    Convert.ToInt32(this.userDataLength, 0x10);
        ...
        public SMS PDUDecoder(string strPDU)
        {
            ...
            SMS msg = new SMS();
            msg.MsgCenter = ServiceCenterAddress;
            msg.Phone = OriginatorAddress;
            msg.Msg = UserData;
            msg.Time = ServiceCenterTimeStamp;
            return msg;
        }
